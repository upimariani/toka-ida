							...
							<div class="row">
								<div class="col-md-6">
									<div class="full invoice_blog padding_infor_info padding-bottom_0">
										<h4>From</h4>
										<p><strong><?= $detail['transaksi']->nama_pelanggan ?></strong><br>
											<strong>Phone : </strong><?= $detail['transaksi']->no_hp ?><br>
										<p><?= $detail['transaksi']->alamat_pengiriman ?></p><br>
								...
								<div class="col-md-6">
									<div class="full invoice_blog padding_infor_info padding-bottom_0">
										...
										<p><strong>Order ID : </strong><?= $detail['transaksi']->id_transaksi ?><br>
											<strong>Payment Due : </strong><?= $detail['transaksi']->tgl_transaksi ?>
										</p>
										<?php
										if ($detail['transaksi']->stat_order != 0) {
										?>
											<h2 class="mt-4 mb-3">Bukti Pembayaran</h2>
											<img style="width: 150px  ;" src="<?= base_url('asset/pembayaran/' . $detail['transaksi']->bukti_payment) ?>">
										<?php
										}
										?>
							...
							<div class="table-responsive">
								<table class="table">
									<tbody>
										...
										<tr>
											<th>Total:</th>
											<td>Rp. <?= number_format($detail['transaksi']->total_transaksi) ?></td>
										</tr>
									</tbody>
								</table>
							</div>
