			...
			<div class="col-md-12">
				<div class="white_shd full margin_bottom_40">
					...
					<div class="container mt-5 mb-5">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" name="harga_supplier" placeholder="Masukkan Harga Supplier Produk" aria-label="Recipient's username" aria-describedby="basic-addon2">
							<div class="input-group-append">
								<span class="input-group-text" id="basic-addon2"><i class="fa fa-tag"></i></span>
							</div>
						</div>
